...
export default function NavBar() {
  ...
  function goTo(path: string) {
    route.push(path);
    setIsMobileMenuOpen(false); // Cierra el menú en móvil al navegar
  }
  ...
  return (
    <>
      ...
      {/* ********************************************************************** */}
      <div className="w-full sticky top-0 z-30 bg-grisNavBar p-2 hidden">
        <div className="flex justify-between items-center">
          ...
          <div className="lg:hidden">
            <button
              ...
              className="text-purple-800 text-lg font-semibold hover:underline"
            >
              {isMobileMenuOpen ? 'x' : 'MENÚ'}
            </button>
          </div>
          ...
          {/* Leyenda */}
          <div className="text-sm md:text-2xl text-purple-800 font-semibold lg:order-last lg:flex lg:items-center">
            FLORES Y MÁS
          </div>
        </div>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden mt-4 flex flex-col gap-y-2">
            <button
              className={`text-base text-purple-800 hover:font-semibold ${
                pathname === '/' && 'font-semibold'
              }`}
              onClick={() => goTo('/')}
            >
