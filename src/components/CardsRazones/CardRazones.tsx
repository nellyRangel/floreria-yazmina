...
export default function CardRazones({ info }: CardRazonesProps) {
  return (
    <div className="flex flex-col justify-normal gap-y-2">
      ...
      <div className="rounded-3xl shadow-xl shadow-shadowBlue/50 px-7 py-4 h-full border border-solid border-gray-400/50 gap-y-6 flex flex-col w-full bg-white">
